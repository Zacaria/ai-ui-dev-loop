...
The documentation SHALL describe the dev loop demo flow, including the URL to open and the command(s) to run locally.
...
The README SHALL include a Live Demo section that provides a URL or states that a live demo is not yet available.
